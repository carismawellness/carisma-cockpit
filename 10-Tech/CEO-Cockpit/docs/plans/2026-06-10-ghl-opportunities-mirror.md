...
Migration goes in `10-Tech/CEO-Cockpit/supabase/migrations/071_ghl_opportunities_mirror.sql`.

---

## 2. Webhook handler

`10-Tech/CEO-Cockpit/app/api/webhooks/ghl/opportunities/route.ts`
...
`10-Tech/CEO-Cockpit/Tools/backfill-ghl-opportunities.ts`
...
`10-Tech/CEO-Cockpit/app/api/crm/ghl-funnel/route.ts` (replace the existing snapshot-only implementation)
...
`10-Tech/CEO-Cockpit/components/crm/PipelineFunnel.tsx`
...
`10-Tech/CEO-Cockpit/app/api/cron/ghl-opportunities-reconcile/route.ts`
