...
**Files:**
- Create: `10-Tech/CEO-Cockpit/supabase/migrations/20260415_brand_standards.sql`
...
```bash
cd 10-Tech/CEO-Cockpit && npx supabase db push
```
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/etl/etl_brand_standards.py`
...
**Files:**
- Modify: `10-Tech/CEO-Cockpit/lib/constants/departments.ts`
...
Run: `cd 10-Tech/CEO-Cockpit && npm run dev`
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/components/brand-standards/MonthPicker.tsx`
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/components/brand-standards/LocationFilter.tsx`
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/lib/hooks/useBrandStandards.ts`
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/components/brand-standards/StandardTab.tsx`
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/components/brand-standards/TrendChart.tsx`
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/app/brand-standards/page.tsx`
...
```bash
cd 10-Tech/CEO-Cockpit && npm run build
```
...
```bash
cd 10-Tech/CEO-Cockpit && npm run lint
```
