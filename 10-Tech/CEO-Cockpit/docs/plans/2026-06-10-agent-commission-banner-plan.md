...
```bash
git add 10-Tech/CEO-Cockpit/lib/constants/agents.ts
...
**Files:**
- Create: `10-Tech/CEO-Cockpit/components/crm/CommissionHeroBanner.tsx`
...
```bash
git add "10-Tech/CEO-Cockpit/components/crm/CommissionHeroBanner.tsx"
...
**Files:**
- Modify: `10-Tech/CEO-Cockpit/app/crm/individual/[slug]/page.tsx`
