...
function SpaDeepaContent({ dateFrom, dateTo }: { dateFrom: Date; dateTo: Date }) {
  ...
  /* ── Performance Snapshot input ────────────────────────────── */
  const spaSnapshotInput = useMemo(() => {
    ...
    // Cash share — sum "Cash" across locations / payment-types total.
  ...
  return (
    <>
      ...
      {/* ── Performance Snapshot (always-on commentary card) ───── */}
      <SalesStrategicCommentary
        input={spaSnapshotInput}
