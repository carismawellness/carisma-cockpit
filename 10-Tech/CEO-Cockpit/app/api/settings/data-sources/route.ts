...
export const DATA_SOURCE_DEFS = [
  ...
  {
    id:          "google_reviews",
    name:        "Google Reviews — Daily Snapshot",
    description: "Daily Google review count + average rating per location (all 10 locations) via the Places API (New). Snapshots into google_reviews and powers the Operations dashboard reviews chart. Requires GOOGLE_PLACES_API_KEY.",
    tables:      ["google_reviews"],
    brand:       "ALL",
    frequency:   "Nightly cron (today's snapshot)",
    log_key:     "google_reviews",
    endpoint:    "/api/etl/google-reviews",
    coverage_table: "google_reviews",
    coverage_col:   "date",
    manual_note: null,
  },
  {
    id:          "diligence_audit",
    name:        "Diligence Audit (Accounting Master Sheet)",
    description: "Monthly per-location financial-compliance figures (total sales, deleted & cancelled, complimentary, cash sales, discounted cash, unattended) from the Accounting Master Sheet's Diligence audit tab. Full-history re-upsert into diligence_audit; drives the Operations diligence heatmap.",
    tables:      ["diligence_audit"],
    brand:       "ALL",
    frequency:   "Nightly cron (full-history re-sync)",
    log_key:     "diligence_audit",
    endpoint:    "/api/etl/diligence-audit",
    coverage_table: "diligence_audit",
    coverage_col:   "month",
    manual_note: null,
  },
  {
    id:          "brand_standards",
    name:        "Brand Standards (Accounting Master Sheet)",
    description: "Facility / Front Desk / Mystery Guest checklist results per location-month from the Accounting Master Sheet. Full re-parse + upsert into brand_standards; powers the Operations standards charts and the Brand Standards page.",
    tables:      ["brand_standards"],
    brand:       "SPA",
    frequency:   "Nightly cron (full-history re-sync)",
    log_key:     "brand_standards",
    endpoint:    "/api/etl/brand-standards",
    coverage_table: "brand_standards",
    coverage_col:   "month",
    manual_note: null,
  },
  {
    id:          "we360",
    name:        "We360 — Employee Productivity & Attendance",
    description: "Per-employee per-day productivity and attendance (online / active / productive / idle time, punch in-out, activity counts) from the We360 Dynamic Report API (dpa.we360.ai workspace). Loaded into we360_productivity_daily; powers the HR Productivity Leaderboard.",
    tables:      ["we360_productivity_daily"],
    brand:       "ALL",
    frequency:   "Nightly cron (rolling 2-month window)",
    log_key:     "we360",
    endpoint:    "/api/etl/we360",
    coverage_table: "we360_productivity_daily",
    coverage_col:   "attendance_date",
    manual_note: null,
  },
  {
...
export async function GET() {
  ...
  const tableCoverage: Array<[string, string, string]> = [
    ...
    ["google_reviews",            "date",            "google_reviews"],
    ["diligence_audit",           "month",           "diligence_audit"],
    ["brand_standards",           "month",           "brand_standards"],
    ["we360_productivity_daily",  "attendance_date", "we360_productivity_daily"],
