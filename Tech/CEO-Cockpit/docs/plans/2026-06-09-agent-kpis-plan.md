...
Start dev server (`npm run dev` from `Tech/CEO-Cockpit/`), navigate to any CRM page, expand CRM → Agent KPIs. Should see all 12 agent names nested under it.

### Step 5: Commit

```bash
git add Tech/CEO-Cockpit/lib/constants/departments.ts
...
**Files:**
- Create: `Tech/CEO-Cockpit/app/api/crm/sync-status/route.ts`
...
```bash
git add "Tech/CEO-Cockpit/app/api/crm/sync-status/route.ts"
...
**Files:**
- Create: `Tech/CEO-Cockpit/components/crm/AgentDetailPanel.tsx`
- Modify: `Tech/CEO-Cockpit/components/crm/AgentDetailTabs.tsx`
...
```bash
cd "Tech/CEO-Cockpit" && npx tsc --noEmit
```
Expected: no errors.
...
```bash
git add "Tech/CEO-Cockpit/components/crm/AgentDetailPanel.tsx" \
        "Tech/CEO-Cockpit/components/crm/AgentDetailTabs.tsx"
...
**Files:**
- Modify: `Tech/CEO-Cockpit/components/crm/AgentLeaderboardCards.tsx`
...
```bash
grep -r "gold" "Tech/CEO-Cockpit/tailwind.config" 2>/dev/null || grep -r "gold" "Tech/CEO-Cockpit/tailwind.config.ts" 2>/dev/null | head -5
```
...
```bash
git add "Tech/CEO-Cockpit/components/crm/AgentLeaderboardCards.tsx"
...
**Files:**
- Modify: `Tech/CEO-Cockpit/app/crm/individual/page.tsx`
...
```bash
git add "Tech/CEO-Cockpit/app/crm/individual/page.tsx"
...
**Files:**
- Create: `Tech/CEO-Cockpit/app/crm/individual/[slug]/page.tsx`

### Step 1: Create the directory

```bash
mkdir -p "Tech/CEO-Cockpit/app/crm/individual/[slug]"
```
...
Check the version:
```bash
grep '"next"' "Tech/CEO-Cockpit/package.json"
```
