/**
 * Klaviyo full historical backfill — Jan 1 to Jun 9 2026
 * Run: npx tsx --env-file .env.production.local Tools/klaviyo-historical-backfill.ts
 */
...
async function main() {
  const dates = dateRange("2026-01-01", "2026-06-09");
  console.log(`Backfilling ${dates.length} days (Klaviyo)`);
